...
const Navbar = () => {
  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 ${scrolled ? "bg-primary" : "bg-transparent"} bg-primary`}>
      <div className="w-full flex justify-between items-center max-w7xl mx-auto">
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          {navLinks.map((nav) =>(
            ...
            >
              <a href={`#${nav.id}`} className='text-red'>
                {nav.title}
              </a>
            </li>
          ))}
